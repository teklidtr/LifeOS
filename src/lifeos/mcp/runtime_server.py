...
LIFEOS_MCP_INSTRUCTIONS = (
    ...
    "discover and read the selected canonical Markdown together, inspect applicable context and "
    "wiki knowledge, jointly reason about the durable delta, group that delta by target, then use "
    "ingestion_evolve_wiki_batch_proposal to create one target-reconciled draft. Do not loop the "
