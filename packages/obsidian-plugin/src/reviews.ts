...
export type GuidedReviewKind="morning"|"evening"|"weekly";
...
export interface ReviewWorkflow{review_id:string;kind:GuidedReviewKind;day:string;range_start:string;range_end:string;sections:ReviewSection[];progress:{completed_sections:string[];skipped_sections:string[];current_section?:string};facts_markdown:string;}
