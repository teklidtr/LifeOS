...
def test_blocked_completed_mode_and_energy_constraints_remain_authoritative() -> None:
    actions = (
        ...
        PlanningAction(
            "done", "Done", "done", 10, "low", "low", "writing", "g", "p", None, (), "plans/p.md"
        ),
        PlanningAction(
            "high", "High", "todo", 10, "high", "low", "writing", "g", "p", None, (), "plans/p.md"
        ),
    )
