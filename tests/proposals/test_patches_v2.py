...
def test_v1_golden_bytes() -> None:
    doc = PatchDocument(
        ...
        operations=(
            ...
            ReplaceGeneratedFile("op-3", "gen2.txt", "sha256:"+"0"*64, "generator-2", "content 3"),
...
def test_v2_construction() -> None:
    doc = PatchDocumentV2(
        ...
        proposal_id="prop-20260713T090000Z-01234567",
        operations=(
            CreateGeneratedFileV2("op-1", "gen1.txt", "absent", "generator-1", "v1.0.0", "content 2"),
            ReplaceGeneratedFileV2("op-2", "gen2.txt", "sha256:"+"0"*64, "generator-2", "v2.0.0", "content 3"),
...
def test_v2_invalid_generator_version() -> None:
    ...
    with pytest.raises(ValueError):
        ReplaceGeneratedFileV2("op-1", "gen1.txt", "sha256:"+"0"*64, "generator-1", "", "content 2")
...
def test_v2_cross_version_rejection() -> None:
    ...
    with pytest.raises(ValueError):
        PatchDocument(
            ...
            proposal_id="prop-20260713T090000Z-01234567",
            operations=(
                CreateGeneratedFileV2("op-1", "gen1.txt", "absent", "generator-1", "v1.0", "content 2"),
            ) # type: ignore
        )
    ...
    with pytest.raises(ValueError):
        PatchDocument(
            ...
            proposal_id="prop-20260713T090000Z-01234567",
            operations=(
                ReplaceGeneratedFileV2("op-1", "gen1.txt", "sha256:"+"0"*64, "generator-1", "v1.0", "content 2"),
            ) # type: ignore
        )
    ...
    with pytest.raises(ValueError):
        PatchDocumentV2(
            ...
            proposal_id="prop-20260713T090000Z-01234567",
            operations=(
                ReplaceGeneratedFile("op-1", "gen1.txt", "sha256:"+"0"*64, "generator-1", "content 2"),
            ) # type: ignore
        )
...
def test_v2_duplicate_rejection() -> None:
    ...
    with pytest.raises(ValueError):
        PatchDocumentV2(
            ...
            operations=(
                CreateGeneratedFileV2("op-1", "gen1.txt", "absent", "generator-1", "v1.0.0", "content 2"),
                CreateGeneratedFileV2("op-1", "gen2.txt", "absent", "generator-1", "v1.0.0", "content 2"),
            )
        )
    # duplicate targets
    with pytest.raises(ValueError):
        PatchDocumentV2(
            ...
            operations=(
                CreateGeneratedFileV2("op-1", "gen1.txt", "absent", "generator-1", "v1.0.0", "content 2"),
                ReplaceGeneratedFileV2("op-2", "gen1.txt", "sha256:"+"0"*64, "generator-1", "v1.0.0", "content 3"),
            )
        )
