---
id: LIFEOS-1307
title: Make daily reviews first-class
status: backlog
phase: 13
depends_on:
  - LIFEOS-1306
...
Deliver a single daily artifact that supports morning orientation, in-day updates, and evening reconciliation.

# Scope

- Combine morning and evening phases in one review note.
- Integrate check-ins, Today planning, task outcomes, study sessions, captures, and attention.
- Allow evening completion when morning was intentionally skipped.
- Add due-state and next-action semantics without forcing a ritual every day.
