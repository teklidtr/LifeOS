---
id: LIFEOS-1310
title: Migrate and rebuild review artifacts
status: backlog
phase: 13
depends_on:
  - LIFEOS-1309
...
Provide conservative migration from legacy review notes and runtime progress plus deterministic rebuild and recovery.

# Scope

- Detect legacy `morning-*`, `evening-*`, and root-level `weekly-*` notes.
- Preview migration, merge daily reflections safely, preserve originals until applied, and record lineage.
- Rebuild disposable review indexes and caches from Markdown.
- Test interruption, stale sources, duplicate identities, and unsupported schemas.
