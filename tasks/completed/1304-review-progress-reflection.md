...
Move resumable progress, answers, reflection prompts, section state, and completion metadata into the canonical review artifact.

# Scope

- Support phase and section completion, intentional skipping, reopening, and current focus.
- Persist structured answers without overwriting free-form reflection.
- Make runtime progress a cache only and rebuild it from Markdown.
- Define completion requirements without gamified scores or mandatory optional sections.
