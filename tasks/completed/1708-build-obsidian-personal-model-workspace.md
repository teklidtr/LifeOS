...
- The missing permanent Obsidian plugin CI checkpoint discovered during this task is captured separately as `LIFEOS-1717`; it is independent infrastructure work and does not expand this task's product scope.
