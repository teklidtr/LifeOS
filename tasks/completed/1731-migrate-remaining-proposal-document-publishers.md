...
Post-fix validation run `34026971052` reran focused publisher/root-hardening coverage, both task validation groups, the full pytest suite, Ruff, mypy, task validation, diff checks, and touched-file formatting.
