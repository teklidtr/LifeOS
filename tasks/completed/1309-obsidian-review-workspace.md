...
Replace the thin wizard controller with an Obsidian-native artifact workspace and review history browser.

# Scope

- Add commands and views for today, current week, active review note, resume, refresh, complete, reopen, and history.
- Expose managed facts, reflection, item decisions, continuity, proposal handoff, stale states, and diagnostics.
- Keep Python as the sole business-rule engine.
- Add keyboard labels, focus restoration, and sparse/degraded states.
